...
class PhoneConfig(object):
    ...
    def process(self):
        ...
        info = self.xml_doc.getElementsByTagName("smartphone_information")[0]
        self.process_smartphone_info(info)
...
if __name__ == "__main__":
    import inspect
    phone_config = PhoneConfig("xml/phone_configs.xml", "Galaxy SII", "233")
    for line in  inspect.getmembers(phone_config):
        print line
